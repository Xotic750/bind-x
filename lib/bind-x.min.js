 ...
 * @module bind-x
 */
"use strict";var isWorking,assertIsFunction=_dereq_("assert-is-function-x"),slice=_dereq_("array-slice-x"),nativeBind="function"==typeof Function.prototype.bind&&Function.prototype.bind;if(nativeBind){var gra,context,attempt=_dereq_("attempt-x"),testThis=[],res=attempt.call(function(arg1,arg2){return context=this,gra=arg1,arguments},nativeBind,testThis,1);if((isWorking=!1===res.threw&&"function"==typeof res.value)&&(res=attempt(res.value,2,3),isWorking=!1===res.threw&&1===gra&&context===testThis&&3===res.value.length),isWorking){var oracle=[1,2,3];res=attempt.call(function(){return isWorking=this!==oracle,oracle},nativeBind,null),(isWorking=!1===res.threw&&"function"==typeof res.value)&&(res=attempt(function(){return new res.value}),isWorking&&(isWorking=!1===res.threw&&res.value===oracle))}}var $bind;if(isWorking)$bind=function bind(target,thisArg){return nativeBind.apply(assertIsFunction(target),slice(arguments,1))};else{var concat=function _concat(a,b){var aLength=a.length,bLength=b.length,result=slice(a);result.length+=bLength;for(var index=0;index<bLength;index+=1)result[aLength+index]=b[index];return result},isPrimitive=_dereq_("is-primitive"),Empty=function _Empty(){};$bind=function _bind(target,thisArg){assertIsFunction(target);var bound,args=slice(arguments,2),boundLength=target.length-args.length;boundLength<0&&(boundLength=0);for(var lastIndex=boundLength-1,boundArgs="",index=0;index<boundLength;index+=1)boundArgs+="$_"+index+"_$"+(index<lastIndex?",":"");return bound=Function("binder","slice","return function ("+boundArgs+"){ return binder.apply(this,slice(arguments)); }")(function _binder(){if(this instanceof bound){var result=target.apply(this,concat(args,arguments));return isPrimitive(result)?this:result}return target.apply(thisArg,concat(args,arguments))},slice),target.prototype&&(Empty.prototype=target.prototype,bound.prototype=new Empty,Empty.prototype=null),bound}}module.exports=$bind},{"array-slice-x":3,"assert-is-function-x":4,"attempt-x":5,"is-primitive":17}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isFunction=_dereq_("is-function-x"),safeToString=_dereq_("safe-to-string-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsFunction(callback){if(!1===isFunction(callback)){var msg=isPrimitive(callback)?safeToString(callback):"#<Object>";throw new TypeError(msg+" is not a function")}return callback}},{"is-function-x":14,"is-primitive":17,"safe-to-string-x":26}],5:[function(_dereq_,module,exports){/**
 ...
 * @module attempt-x
 */
"use strict";var arrayLikeSlice=_dereq_("array-like-slice-x");module.exports=function attempt(fn){try{return{threw:!1,value:fn.apply(this,arrayLikeSlice(arguments,1))}}catch(e){return{threw:!0,value:e}}}},{"array-like-slice-x":2}],6:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var boxedString=Object("a");module.exports="a"===boxedString[0]&&0 in boxedString},{}],7:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";module.exports="function"==typeof Symbol&&"symbol"==typeof Symbol("")},{}],8:[function(_dereq_,module,exports){/**
 ...
 * @module is-falsey-x
 */
"use strict";module.exports=function isFalsey(value){return!1===Boolean(value)}},{}],13:[function(_dereq_,module,exports){/**
 ...
 * @module is-finite-x
 */
"use strict";var numberIsNaN=_dereq_("is-nan-x");module.exports=function isFinite(number){return"number"==typeof number&&!1===numberIsNaN(number)&&number!==1/0&&number!==-1/0}},{"is-nan-x":15}],14:[function(_dereq_,module,exports){/**
 ...
 * @module math-sign-x
 */
"use strict";var toNumber=_dereq_("to-number-x"),numberIsNaN=_dereq_("is-nan-x");module.exports=function sign(x){var n=toNumber(x);return 0===n||numberIsNaN(n)?n:n>0?1:-1}},{"is-nan-x":15,"to-number-x":30}],22:[function(_dereq_,module,exports){"use strict";module.exports=9007199254740991},{}],23:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var trim=_dereq_("trim-x"),reNormalize=new RegExp("["+_dereq_("white-space-x").string+"]+","g");module.exports=function normalizeSpace(string){return trim(string).replace(reNormalize," ")}},{"trim-x":37,"white-space-x":39}],24:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isString=_dereq_("is-string"),STRIP_COMMENTS=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;module.exports=function replaceComments(string){var replacement=arguments.length>1&&isString(arguments[1])?arguments[1]:"";return isString(string)?string.replace(STRIP_COMMENTS,replacement):""}},{"is-string":18}],25:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var toInteger=_dereq_("to-integer-x"),MAX_SAFE_INTEGER=_dereq_("max-safe-integer");module.exports=function toLength(value){var len=toInteger(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len}},{"max-safe-integer":22,"to-integer-x":28}],30:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":20,"validate.io-undefined":38}],34:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":19}],35:[function(_dereq_,module,exports){/**
