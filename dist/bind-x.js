...
if (nativeBind) {
  ...
  var testThis = [];
  var res = attempt_x_esm.call(fn, nativeBind, testThis, 1);
  isWorking = res.threw === false && typeof res.value === 'function';

  if (isWorking) {
    res = attempt_x_esm(res.value, 2, 3);
  ...
  if (isWorking) {
    ...
    res = attempt_x_esm.call(Ctr, nativeBind, null);
    isWorking = res.threw === false && typeof res.value === 'function';

    if (isWorking) {
      res = attempt_x_esm(function () {
