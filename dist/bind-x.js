...
function array_slice_x_esm_slice(array, start, end) {
  ...
  return nativeSlice.apply(object, slice(arguments, 1));
}
...
if (isWorking) {
  ...
  $bind = function bind(target, thisArg) {
    /* eslint-disable-next-line prefer-rest-params */
    return nativeBind.apply(assertIsFunction(target), array_slice_x_esm_slice(arguments, 1));
  };
} else {
  var bind_x_esm_concat = function concat(a, b) {
    var aLength = a.length;
    var bLength = b.length;
    var result = array_slice_x_esm_slice(a);
  ...
  $bind = function bind(target, thisArg) {
    ...
    var args = array_slice_x_esm_slice(arguments, 2);
    var bound;
    ...
    bound = Function('binder', 'slice', "return function (".concat(boundArgs, "){ return binder.apply(this,slice(arguments)); }"))(binder, array_slice_x_esm_slice);
...
//# sourceMappingURL=bind-x.js.map